...
import WireTransport from "./wire-transport"
import SEA from "./sea"
import type { UserIdentity, MeshOptions, LexFilter, WireOptions } from "./schemas"
import type { MeshAPI } from "./mesh"

type WireInterface = ReturnType<typeof WireTransport>
 ...
 */
const User = (opt: MeshOptions | undefined, wire?: WireInterface): UserInterface => {
  if (!wire) wire = createWire(opt as MeshOptions)
