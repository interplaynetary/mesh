 ...
 * Note: GraphValue is recursive to allow nested objects (verified in src/mesh.js check() function)
 */
 ...
 * User metadata keys
 */
export const USER_PUBLIC_KEY = "_mesh_user_public_key"
export const USER_SIGNATURE = "_mesh_user_signature"
 ...
 * Mesh options
 */
export const MeshOptionsSchema = z
  .object({
  ...
  .passthrough()
export type MeshOptions = z.infer<typeof MeshOptionsSchema>
...
export type { WireAPI as WireInterface } from "./wire-transport"
