# TypeScript Implementation of Mesh

This directory contains the TypeScript conversion of the Mesh graph database, implementing a strict Zod-first architecture with 100% type coverage.
...
node --test ts/test/mesh.get.test
...
```typescript
import Mesh from "./dist/src/mesh.js"

const db = Mesh({ file: "data", wss: websocketServer })
...
```typescript
// Add type imports
import type { MeshAPI, GraphNode } from "../src/mesh.js"
